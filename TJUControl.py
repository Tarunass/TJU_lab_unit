...
class TJUControl(threading.Thread):
    def __init__(self, logger=None,
                       ...
                       control_address=("192.168.1.3", 60000),
                       light_server_address=("192.168.1.3", 50000),
                       relay_address=("192.168.1.7", 50003)):
        ...
        time.sleep(60)  # Wait for lights to start up
    ...
    def _start_sequence(self):
        ...
        1. Send "Start" to 192.168.1.7:50000
